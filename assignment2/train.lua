...
require 'optim'
require 'sgd'     -- stochastic descent method, for online and batch methods
require 'cd'      -- coodinate descent method, for online and batch methods
...
local function train(trainData)
   ...
   for t = 1,trainData:size(),opt.batchSize do
      ...
      if opt.optMethod == 'sgd' or opt.optMethod == 'sgd_w' or opt.optMethod == 'sgd_wm' then
         sgd(eval_E, w, optimState)
      elseif opt.optMethod == 'cd' then
         cd(eval_E, w, optimState)
      else
